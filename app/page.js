...
export default function Waitlist() {
  ...
  return (
    <>
      ...
      <section id="LearnMore" className="flex w-screen h-screen bg-gradient-to-b from-[#2C174C] to-[#07052D]">    
        <div className="m-24">
          <div className="flex flex-col space-y-10">
            ...
            <a href="#ThankYou">
              <button className="font-chillax font-medium w-44 text-[#07052D] bg-[#E8DBFF] rounded-full px-5 py-1 shadow-[#A781E2] border border-t-0 border-[#544072] cursor-pointer hover:-translate-y-3 duration-300"> Join Clarity AI </button>
            </a>
      ...
      <section id="ThankYou" className="flex w-screen h-screen bg-gradient-to-b from-[#07052D] to-[#2C174C]">
        ...
        <div className="flex flex-col space-y-24 m-24">
          <motion.div 
            ...
            <div className="font-axiforma font-bold text-[#E8DBFF] text-7xl"> Thank you </div>    
            <div className="font-axiforma font-bold text-[#E8DBFF] text-7xl"> for your interest in Clarity AI! </div>
          </motion.div>

          <div className="flex flex-row space-x-44"> 
            <div className="flex flex-col space-y-8 text-[#E8DBFF] font-chillax font-normal leading-32">
              <div> Take a moment to follow us on <span className="font-semibold"> Instagram, LinkedIn, & Discord </span>. These platforms are where we share <br/> exciting updates and helpful information. </div>

              <div> As a <span className="font-semibold"> non-profit organization, </span> every follow helps us grow our community and continue providing <br/> valuable resources for students like you. 
            ...
            <motion.div 
              ...
              className="flex flex-col space-y-10 text-[#E8DBFF] font-chillax font-normal">

              <div className="flex flex-col space-y-4 justify-center items-center">
                <div className="font-semibold text-2xl text-center"> Step 1:  Follow Us </div>
              ...
              <div className="flex flex-col space-y-4 justify-center items-center">
                <div className="font-semibold text-2xl text-center"> Step 2:  Verify </div>
                <div className="font-normal"> Have you followed Clarity AI on our socials? </div>
                <Link href="/waitlistPage" className="font-chillax font-medium w-44 text-center text-[#07052D] bg-[#E8DBFF] rounded-full px-5 py-1 border border-t-0 border-[#544072] cursor-pointer hover:-translate-y-2 duration-300"> Yes, Join Now! </Link>
              </div>
            </motion.div>
